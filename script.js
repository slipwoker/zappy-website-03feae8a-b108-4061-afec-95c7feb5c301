document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function createErrorElement(field) {
            ...
            errorElement.style.cssText = 'color: #e74c3c; font-size: 0.85em; margin-top: 4px; display: none;';
        ...
        function showFormMessage(type, message) {
            ...
            if (!messageElement) {
                ...
                messageElement.style.cssText = 'padding: 12px; margin-top: 16px; border-radius: 4px; font-weight: 500;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '03feae8a-b108-4061-afec-95c7feb5c301',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '03feae8a-b108-4061-afec-95c7feb5c301';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '03feae8a-b108-4061-afec-95c7feb5c301';
